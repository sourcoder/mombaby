...
<div class="text-center food-intro">
    <h2>海带玉米排骨汤</h2>
    <div class = "tag">
        <span class="label label-success">富含纤维</span>
    ...
    <div class="panel panel-default">
      ...
      <ol class="list-group">
        <li class="list-group-item">
            <img alt="" src="../image/food/3.jpg">
            <p class = "text-left">1.&nbsp;排骨洗干净，煮五分钟，去掉血沫</p>
        </li>
        <li class="list-group-item">
            <img alt="" src="../image/food/3.jpg">
            <p class = "text-left">2.&nbsp;排骨洗干净，煮五分钟，去掉血沫</p>
        </li>
        <li class="list-group-item">
            <img alt="" src="../image/food/3.jpg">
            <p class = "text-left">3.&nbsp;排骨洗干净，煮五分钟，去掉血沫</p>
        </li>
      </ol>
</div>
</div>